...
-   A [new integration for LDAP]({{<relref "/rs/security/access-control/ldap">}}) authentication and
...
-   An enhanced [clients mutual authentication]({{<relref "/rs/security/encryption/tls">}})
...
All known bugs around setting ciphers were fixed.  To learn more, see [Configure cipher suites]({{<relref "/rs/security/encryption/tls/ciphers">}}).
