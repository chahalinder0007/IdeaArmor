...
Follow [these instructions]({{< relref "/rs/installing-upgrading/upgrading" >}}) for upgrading to RS 6.0 from RS 5.4.0 and above.
...
For more information, check out the [Redis Enterprise Software user management documentation]({{<relref "/rs/security/access-control/rbac/configure-acl" >}}).
...
- [RedisBloom](https://redislabs.com/redis-enterprise/redis-bloom/), version [2.2.2]({{< relref "/stack/release-notes/redisbloom/redisbloom-2.2-release-notes.md" >}}) (updated)
- [RedisGraph](https://redislabs.com/redis-enterprise/redis-graph/), version [2.0.11]({{< relref "/stack/release-notes/redisgraph/redisgraph-2.0-release-notes.md" >}}) (updated)
...
- [RediSearch](https://redislabs.com/redis-enterprise/redis-search/), version [1.6.12]({{< relref "/stack/release-notes/redisearch/redisearch-1.6-release-notes.md" >}}) (updated)
- [RedisTimeSeries](https://redislabs.com/redis-enterprise/redis-time-series/), version [1.2.5]({{< relref "/stack/release-notes/redistimeseries/redistimeseries-1.2-release-notes.md" >}}) (updated)
