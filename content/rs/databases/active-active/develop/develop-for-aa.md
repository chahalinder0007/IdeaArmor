...
The default policy for Active-Active databases is _noeviction_ mode. Redis Enterprise version 6.0.20 and later support all eviction policies for Active-Active databases, unless [Auto Tiering]({{<relref "/rs/databases/auto-tiering">}})(previously known as Redis on Flash) is enabled.
