...
* Support for [Auto Tiering]({{<relref "/kubernetes/re-clusters/auto-tiering.md">}}) (RED-78613)
...
* `.isRoF` and `.rofRamSize` added to support the [Auto Tiering feature]({{<relref "/kubernetes/re-clusters/auto-tiering.md">}}).
