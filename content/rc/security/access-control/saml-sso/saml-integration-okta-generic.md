...
Learn how to use the generic application template. You can also refer to the [Org2Org]({{<relref "/rc/security/access-control/saml-sso/saml-integration-okta-org2org">}}) application template.
